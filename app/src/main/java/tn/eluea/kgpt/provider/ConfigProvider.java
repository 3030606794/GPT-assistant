...
public class ConfigProvider extends ContentProvider {
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        // Defensive parsing: invalid values coming from other processes must not crash
        // the caller (e.g. the IME process).
        try {
            switch (type) {
                case TYPE_INT:
                    try {
                        ...
                        Log.w(TAG, "Invalid int for key=" + key + ": " + value);
                ...
                case TYPE_LONG:
                    try {
                        ...
                        Log.w(TAG, "Invalid long for key=" + key + ": " + value);
                        editor.putString(key, value);
                        type = TYPE_STRING;
                    }
                    break;
                case TYPE_FLOAT:
                    try {
                        ...
                        Log.w(TAG, "Invalid float for key=" + key + ": " + value);
                        editor.putString(key, value);
                        type = TYPE_STRING;
                    }
                    break;
            ...
            Log.e(TAG, "insert failed for key=" + key + " type=" + type + ": " + t.getMessage());
            return null;
        }
