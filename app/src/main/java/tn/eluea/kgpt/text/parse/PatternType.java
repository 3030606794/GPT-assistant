...
public enum PatternType {
    ...
    // Default AI trigger symbol for this build: $GPT
    CommandAI("AI 触发器", 1, "([\\s\\S]+)\\$GPT$", true, "$GPT", "输入文本并在末尾加 $GPT"),
    ...
    // Word/menu triggers in this build use suffix symbols.
    ModelSwitch("ChatGPT助手", 0, "\\$ChatGPT\\s*$", true, "$ChatGPT", "输入触发词弹出模型选择"),
    AIClipboard("AI剪贴板", 0, "\\$jtb\\s*$", true, "$jtb", "输入触发词弹出AI剪贴板"),
    QuickJumpMenu("快捷跳转", 0, "\\$kjtz\\s*$", true, "$kjtz", "输入触发词弹出快捷跳转"),
    ;
