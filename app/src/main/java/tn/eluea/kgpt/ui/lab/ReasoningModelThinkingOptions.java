...
public final class ReasoningModelThinkingOptions {
    ...
    public static String toNativeReasoningEffort(int id) {
        switch (id) {
            case LOW:
                return "low";
            case MEDIUM:
    ...
    public static boolean isStyleHintMode(int id) {
        return id == DIVERGENT || id == CONVERGENT;
    }

    public static boolean isDepthMode(int id) {
