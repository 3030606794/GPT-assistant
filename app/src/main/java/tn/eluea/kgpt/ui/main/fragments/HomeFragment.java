...
public class HomeFragment extends Fragment {
    ...
    private View cardAiSettings, cardAiChat, cardWebSearch;
    private MaterialCardView cardHowToUse;
    private FrameLayout btnInfo;
    private View rootView;

    // Quick Action icons for candy colors
    private android.widget.ImageView iconInvocation, iconAiChat, iconWebSearch;
    ...
    private void initViews(View view) {
        ...
        cardAiChat = view.findViewById(R.id.card_ai_chat);
        ...
        iconAiChat = view.findViewById(R.id.icon_ai_chat);
    ...
    private void setupClickListeners() {
        ...
        cardAiChat.setOnClickListener(v -> {
            // Open in-app AI chat (for testing provider/model configuration)
            try {
                Intent i = new Intent(requireContext(), tn.eluea.kgpt.ui.chat.AiChatActivity.class);
                startActivity(i);
    ...
    private int getSearchEngineIconResId(String engineId) {
        switch (engineId) {
            case "duckduckgo":
                return R.drawable.ic_engine_duckduckgo;
            case "google":
                return R.drawable.ic_engine_google;
            case "bing":
                return R.drawable.ic_engine_bing;
            case "brave":
                return R.drawable.ic_engine_brave;
            case "ecosia":
                return R.drawable.ic_engine_ecosia;
            case "yahoo":
                return R.drawable.ic_engine_yahoo;
            case "yandex":
                return R.drawable.ic_engine_yandex;
            case "qwant":
                return R.drawable.ic_engine_qwant;
            case "startpage":
                return R.drawable.ic_engine_startpage;
            case "perplexity":
                return R.drawable.ic_engine_perplexity;
            case "phind":
                return R.drawable.ic_engine_phind;
            default:
                return R.drawable.ic_engine_duckduckgo;
        }
    }
    ...
    private void showSearchEngineBottomSheet() {
        ...
        for (String[] engine : SEARCH_ENGINES) {
            ...
            android.widget.ImageView ivIcon = optionView.findViewById(R.id.iv_option_icon);
            if (ivIcon != null) {
                ivIcon.setImageResource(getSearchEngineIconResId(engine[0]));
            }
