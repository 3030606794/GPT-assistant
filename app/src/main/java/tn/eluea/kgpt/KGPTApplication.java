...
protected void attachBaseContext(Context base) {
    ...
    public void onCreate() {
        ...
        // Start system clipboard monitoring in KGPT app process.
        // This makes "AI剪贴板" able to capture system clipboard changes even when
        // the Xposed clipboard hook isn't active (e.g., scope not including System Framework).
        try {
            tn.eluea.kgpt.clipboard.SystemClipboardMonitor.ensureStarted(this);
    ...
    private void applyGlobalTheme() {
        ...
        // Defensive read: some environments/older versions may store this key as an int.
        // Using SharedPreferences.getBoolean() directly would crash with ClassCastException.
        boolean isDarkMode = PrefsCompat.getThemeIsDark(this, prefs, PREF_THEME, false);
