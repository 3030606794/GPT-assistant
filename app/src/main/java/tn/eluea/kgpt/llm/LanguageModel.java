...
public enum LanguageModel {
    ...
    DeepSeek("DeepSeek", "deepseek-chat", "https://api.deepseek.com/v1", false,
            "https://platform.deepseek.com/api_keys"),
    Doubao("豆包", "doubao-seed-1-6-250615", "https://ark.cn-beijing.volces.com/api/v3", false,
            "https://console.volcengine.com/ark"),
    Qwen("千问", "qwen-plus", "https://dashscope.aliyuncs.com/compatible-mode/v1", false,
            "https://dashscope.console.aliyun.com/apiKey"),
    Groq("Groq", "llama-3.3-70b-versatile", "https://api.groq.com/openai/v1", true, "https://console.groq.com/keys"),
    Grok("Grok", "grok-beta", "https://api.x.ai/v1", false,
            "https://console.x.ai"),
