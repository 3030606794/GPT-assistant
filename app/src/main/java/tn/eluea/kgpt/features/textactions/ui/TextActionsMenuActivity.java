...
protected void attachBaseContext(android.content.Context newBase) {
    ...
    private void copyToClipboard(String text) {
        ...
        if (clipboard != null) {
            ClipData clip = ClipData.newPlainText(getString(R.string.ui_text_actions_ai_result_label), text);
    ...
    public void onAIError(Throwable t) {
        mainHandler.post(() -> {
            Toast.makeText(this, getString(R.string.ui_text_actions_ai_error, String.valueOf(t.getMessage())), Toast.LENGTH_LONG).show();
            if (currentResult != null) {
                uiComposer.showResult(currentResult, isReadonly);
            } else {
                showMainMenu();
