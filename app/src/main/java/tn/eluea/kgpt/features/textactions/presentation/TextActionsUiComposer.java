...
public class TextActionsUiComposer {
    ...
    public void showLoading() {
        ...
        generatingText.setText(context.getString(R.string.ui_text_actions_generating));
    ...
    public void showResult(String result, boolean isReadonly) {
        ...
        if (!isReadonly) {
            ...
            row1.addView(createButton(context.getString(R.string.ui_text_actions_replace), v -> listener.onReplaceClicked()),
            ...
            row1.addView(createButton(context.getString(R.string.ui_text_actions_append), v -> listener.onAppendClicked()),
                    new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
        ...
        row2.addView(createButton(context.getString(R.string.ui_text_actions_translate), v -> listener.onTranslateClicked()),
                new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));

        View s2 = new View(context);
        row2.addView(s2, new LinearLayout.LayoutParams(dp(8), dp(1)));

        row2.addView(createButton(context.getString(R.string.ui_text_actions_copy), v -> listener.onCopyClicked()),
                new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
        ...
        row3.addView(createButton(context.getString(R.string.ui_text_actions_close), v -> listener.onCloseClicked()),
                new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
    ...
    public void showLanguageSelector(List<String> languages) {
        ...
        header.setText(context.getString(R.string.ui_text_actions_select_language));
        ...
        cancelBtn.setText(context.getString(R.string.ui_text_actions_cancel));
